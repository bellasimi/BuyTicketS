...
public class LoggingAdvice {
	...
	// target �޼����� �Ķ���͵� ������ ����մϴ�.
	@Before("execution(* com.bts.*.service.*.*(..)) or "
			+ "execution(* com.bts.*.dao.*.*(..))")
	...
	@After("execution(* com.bts.*.service.*.*(..)) or "
			+ "execution(* com.bts.*.*.dao.*.*(..))")
	...
	// target �޼ҵ��� ���� �ð��� �����մϴ�.
	@Around("execution(* com.bts.*.service.*.*(..)) or "
			+ "execution(* com.bts.*.dao.*.*(..))")
