...
public interface MyPageController {
	...
	public ModelAndView review(@RequestParam("order_id") String order_id,@RequestParam("goods_title") String goods_title,HttpServletRequest request, HttpServletResponse response)  throws Exception;
