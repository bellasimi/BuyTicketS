			...
			<tr >
				...
				<td width=500>
				  <select name="goods_sort">	
						...
						<option value="economy">경제/경영
						<option value="college">대학교재
						<option value="improve">자기계발
						<option value="science">자연과학/공학
						<option value="human">역사/인문학
						<option value="pop">가요
						<option value="rock">록
						<option value="classic">클래식
						<option value="newage">뉴에이지
