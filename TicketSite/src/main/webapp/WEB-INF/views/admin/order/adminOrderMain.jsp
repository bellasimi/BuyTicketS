...
{	
	temp=calcPeriod(search_period);mp.split(",");
	beginDate=date[0];
	endDate=date[1];
...
// 		type : "post",
// 		async : false,
// 		url : "${contextPath}/admin/order/adminOrderMain.do",
// 		data : {
// 			order_id:order_id
// // 			,
        ...
        <c:choose>
          <c:when test="${item.order_id != pre_order_id }">
				...
				<td width=30% align=left >
				    <strong>성함:${item.orderer_name}</strong><br>
					<strong>번호:${item.orderer_hp}</strong><br>
				</td>  
				<td width=30% align=left >
				 	<strong>상품명:${item.goods_title}</strong><br>
				 	<strong>수량 : ${item.order_goods_qty}장</strong>
