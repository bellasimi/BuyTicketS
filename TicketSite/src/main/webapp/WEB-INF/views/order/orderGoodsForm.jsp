	...
	for(var i=0; i<r_pay_method.length;i++){
	  if(r_pay_method[i].checked==true){
		  ...
		  if(pay_method=="신용카드"){
			...
			var i_pay_order_hp1=document.getElementById("pay_order_hp1");
			var i_pay_order_hp2=document.getElementById("pay_order_hp2");
			var i_pay_order_hp3=document.getElementById("pay_order_hp3");
			pay_orderer_hp_num=i_pay_order_hp1.value+"-"+
						   	    i_pay_order_hp2.value+"-"+
							    i_pay_order_hp3.value;
...
<form  name="form_order">	
	<table class="list_view">
		<tbody align=center>
			...
			<!-- 총주문금액 -->
					<td>
					<fmt:formatNumber value="${item.goods_sales_price*0.9 * item.order_goods_qty}" var="sales_qty_price" pattern="#,###"/>
		...
		<!-- 총배송비 구하기
			...
			<c:set var="total_order_goods_qty"
				...
				<input type="hidden" value="${t_deliveryprice}"  id="total_delivery_price"/>
	...
	<table width=80% class="list_view" style="background: #ccffff">
		...
		<!-- 총배송비 -->		
				<td>
					<p id="p_totalDelivery">
					<fmt:formatNumber var="tdeliveryprice" value="${t_deliveryprice}" pattern="#,###"/>
					${tdeliveryprice}원</p> 
					<input id="h_totalDelivery" type="hidden" value="${t_deliveryprice}" />
				</td>
			...
			<tbody>
				...
				<tr id="tr_pay_phone" style="visibility:hidden">
				  ...
				  <strong>휴대폰 번호 입력: <strong>
				  	       <input  type="text" size="5" value=""  id="pay_order_hp1" name="pay_order_hp1" />-
				           <input  type="text" size="5" value="" id="pay_order_hp2" name="pay_order_hp2" />-
				           <input  type="text" size="5" value="" id="pay_order_hp3" name="pay_order_hp3" />
				  </td>
				</tr>
			</tbody>
		</table>
